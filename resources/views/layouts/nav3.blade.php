...
<body class="font-sans text-gray-900 antialiased">
    <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Explore</a>
            </div>
        </div>
    </nav>

    <div class="content w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <!-- Your main content goes here -->
        <h1 class="text-2xl font-semibold">Welcome to Inspiro!</h1>
        <p class="mt-2">Your one-stop destination for inspiration. Explore, save, and share your ideas!</p>
    </div>
    ...
    <footer class="bg-gray-100 py-4 mt-8">
        <div class="max-w-7xl mx-auto text-center">
            <p class="text-sm text-gray-600">&copy; {{ date('Y') }} Inspiro. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>
