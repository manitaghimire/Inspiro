...
<body class="font-sans text-gray-900 antialiased">
   ...
   /* blades comment is {{-- content --}} */
    
   <div class="content w-full sm:w-9/10 mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg mx-auto" style="width: 90%; max-width: 90%; display: flex; justify-content: center;">
